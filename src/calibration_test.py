...
upper = np.array([120 * deg, 100.0, 100.0, 0, np.pi / 2, np.pi, 360 * deg])
...
for img_path in images:
    ...
    cv2.line(img, tuple(pixels[0]), tuple(pixels[2]), (255, 0, 0), 3)
    cv2.line(img, tuple(pixels[0]), tuple(pixels[9]), (255, 0, 0), 3)
    cv2.line(img, tuple(pixels[2]), tuple(pixels[11]), (255, 0, 0), 3)
    cv2.line(img, tuple(pixels[9]), tuple(pixels[11]), (255, 0, 0), 3)
